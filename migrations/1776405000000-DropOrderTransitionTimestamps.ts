...
export class DropOrderTransitionTimestamps1776405000000 implements MigrationInterface {
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE INDEX "IDX_b3931722e5fd238f75645f8d15" ON "order_status_history" ("order_id", "created_at") `);
    ...
    public async down(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`DROP INDEX "public"."IDX_b3931722e5fd238f75645f8d15"`);
